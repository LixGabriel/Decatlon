...
function ready() {
    ...
    var addToCartButtons = document.getElementsByClassName("comanda-produs");
...
function addToCartClicked(event) {
    ...
    var price = shopItem.getElementsByClassName("pret-produs")[0].innerText;
...
function addItemToCart(title, price, imageSrc) {
    ...
    for (let i = 0; i < cartItemNames.length; i++) {
        if (cartItemNames[i].innerText == title) {
            alert("Produsul este deja adaugat in cos!");
            return;
        }
    }
